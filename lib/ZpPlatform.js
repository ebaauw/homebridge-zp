...
class ZpPlatform extends homebridgeLib.Platform {
  ...
  handleZonePlayerZoneGroupTopologyEvent (zpClient, zoneGroupState) {
    this.debug('ZoneGroupTopology: %j', zoneGroupState)
