...
const ZpAirTunesServer = require('./ZpAirTunesServer')
...
function ZpAccessory (platform, zp) {
  ...
  if (this.platform.airtunes) {
    this.airTunesServer = new ZpAirTunesServer(this)
    this.airTunesServer.start() // TODO: better way to reserve the port
  }
