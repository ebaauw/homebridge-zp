...
class ZpClient extends events.EventEmitter {
  ...
  async getZoneAttributes () {
    return this._post(null, 'DeviceProperties', 'GetZoneAttributes', {})
  }

  async getZoneInfo () {
    return this._post(null, 'DeviceProperties', 'GetZoneInfo', {})
  }

  async getZoneGroupAttributes () {
    return this._post(null, 'ZoneGroupTopology', 'GetZoneGroupAttributes', {})
  }

  async listAlarms () {
    return this._post(null, 'AlarmClock', 'ListAlarms', {})
  }
  ...
  async _post (device, service, action, options) {
    ...
    const requestObj = {
      url: (device == null ? '' : '/' + device) + '/' + service + '/Control',
      method: 'POST',
      headers: {
