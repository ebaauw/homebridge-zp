...
function setHomebridge(homebridge) {
  ...
  Characteristic.ZoneGroup = function() {
    Characteristic.call(this, 'Zone Group', '04200004-0000-1000-8000-0026BB765291');
    this.setProps({
      format: Characteristic.Formats.STRING,
      perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY]
    });
  ...
  util.inherits(Characteristic.ZoneGroup, Characteristic);
}
...
function ZPPlatform(log, config) {
  ...
  this.groupvolume = config.groupvolume || false;
