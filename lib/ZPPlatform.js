...
// - Use custom chacacteristics from homebridge-hue-utils.
...
function setHomebridge (homebridge) {
  ...
  Characteristic.CurrentTrack = function () {
    Characteristic.call(this, 'Track', Characteristic.CurrentTrack.UUID)
    this.setProps({
  ...
  Characteristic.ChangeTrack = function () {
    Characteristic.call(this, 'Track Change', Characteristic.ChangeTrack.UUID)
    this.setProps({
      format: Characteristic.Formats.INT,
      minValue: -1,
      maxValue: 1,
  ...
  // Custom homekit characteristic for changing volume.
  Characteristic.ChangeVolume = function () {
    Characteristic.call(this, 'Volume Change', Characteristic.ChangeVolume.UUID)
    this.setProps({
      format: Characteristic.Formats.INT,
      minValue: -1,
      maxValue: 1,
  ...
  util.inherits(Characteristic.ChangeVolume, Characteristic)
  Characteristic.ChangeVolume.UUID = '00000049-0000-1000-8000-656261617577'
...
function ZPPlatform (log, config) {
  ...
  this.resetTimeout = config.resetTimeout || 50 // milliseconds
