...
function setHomebridge(homebridge) {
  ...
  Characteristic.Bass = function() {
    Characteristic.call(this, 'Bass', '04200000-0000-1000-8000-0026BB765291');
    this.setProps({
  ...
  Characteristic.Treble = function() {
    Characteristic.call(this, 'Treble', '04200001-0000-1000-8000-0026BB765291');
    this.setProps({
      format: Characteristic.Formats.INT,
      minValue: -10,
      maxValue: 10,
  ...
  Characteristic.Loudness = function() {
    Characteristic.call(this, 'Loudness', '04200002-0000-1000-8000-0026BB765291');
    this.setProps({
  ...
  Characteristic.CurrentTrack = function() {
    Characteristic.call(this, 'Current Track', '04200003-0000-1000-8000-0026BB765291');
    this.setProps({
  ...
  Characteristic.SonosGroup = function() {
    Characteristic.call(this, 'Sonos Group', '04200004-0000-1000-8000-0026BB765291');
    this.setProps({
      format: Characteristic.Formats.STRING,
      perms: [Characteristic.Perms.READ, Characteristic.Perms.NOTIFY]
    });
  ...
  Characteristic.Track = function() {
    Characteristic.call(this, 'Track', '04200005-0000-1000-8000-0026BB765291');
    this.setProps({
      format: Characteristic.Formats.INT,
      minValue: -1,
      maxValue: 1,
...
function ZPPlatform(log, config) {
  ...
  if (config.light !== undefined) {
    this.log.error("config.json: warning: \"light\" has been deprecated");
    config.service = "light";
  }
  if (config.zonegroups !== undefined) {
    this.log.error("config.json: warning: \"zonegroups\" has been deprecated");
  }
  ...
  var msg = util.format.apply(msg, ["%s v%s, node %s, homebridge api v%s",
