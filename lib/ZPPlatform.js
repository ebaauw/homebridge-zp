...
function setHomebridge(homebridge) {
  ...
  Characteristic.Bass.UUID = '04200000-0000-1000-8000-0026BB765291';
  ...
  Characteristic.Treble.UUID = '04200001-0000-1000-8000-0026BB765291';
  ...
  Characteristic.Loudness.UUID = '04200002-0000-1000-8000-0026BB765291';
  ...
  Characteristic.CurrentTrack.UUID = '04200003-0000-1000-8000-0026BB765291';
  ...
  Characteristic.SonosGroup.UUID = '04200004-0000-1000-8000-0026BB765291';
  // Characteristic.SonosGroup.UUID = '00000045-0000-1000-8000-656261617577';

  // Custom homekit characteristic for changing track.
  Characteristic.Track = function() {
    Characteristic.call(this, 'Track', Characteristic.Track.UUID);
    this.setProps({
      format: Characteristic.Formats.INT,
      minValue: -1,
      maxValue: 1,
  ...
  Characteristic.Track.UUID = '00000046-0000-1000-8000-656261617577';
