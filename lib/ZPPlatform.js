...
function setHomebridge(homebridge) {
  ...
  // Homekit characteristic for volume.
  // This characteristic has been defined in the iOS 10 version of homekit,
  // but it is not yet included in HAP-NodeJS.
  Characteristic.AudioVolume = function() {
  ...
  util.inherits(Characteristic.AudioVolume, Characteristic);

  // Homekit characteristic for mute.
  // This characteristic has been defined in the iOS 10 version of homekit,
  // but it is not yet included in HAP-NodeJS.
  Characteristic.AudioMute = function() {
  ...
  util.inherits(Characteristic.AudioMute, Characteristic);
...
function ZPPlatform(log, config) {
  ...
  this.host = config.host || ip.address("en0") || ip.address("en1") || ip.address();
