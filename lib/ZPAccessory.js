...
function ZPAccessory(platform, zp) {
  ...
  //   .on("get", function(callback) {callback(null, 0);}.bind(this))
  //   .on("set", this.setGroupTrack.bind(this));
  this.groupService.addOptionalCharacteristic(Characteristic.CurrentTrack);
  this.groupService.getCharacteristic(Characteristic.CurrentTrack)
  ...
  this.groupService.getCharacteristic(Characteristic.SonosGroup)
  ...
  this.zoneService.getCharacteristic(Characteristic.Bass)
    .on("get", function(callback) {callback(null, this.state.zone.bass);}.bind(this))
  ...
  this.zoneService.getCharacteristic(Characteristic.Treble)
    .on("get", function(callback) {callback(null, this.state.zone.treble);}.bind(this))
  ...
  this.zoneService.getCharacteristic(Characteristic.Loudness)
    .on("get", function(callback) {callback(null, this.state.zone.loudness);}.bind(this))
