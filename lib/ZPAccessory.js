...
const ZpAirPlayServer = require('./ZpAirPlayServer')
...
function ZPAccessory (platform, zp) {
  ...
  if (this.platform.airplay) {
    this.airPlayServer = new ZpAirPlayServer(this)
  }
          ...
          if (!err && json['DIDL-Lite']) {
            ...
            if (item.res != null && item.res[0] != null && item.res[0]._ != null) {
              ...
              switch (type.split(':')[0]) {
                ...
                case 'x-rincon-mp3radio': // AirPlay (by homebridge-zp).
